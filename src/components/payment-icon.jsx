    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset="0.00143105" stopColor="#11888F" />
          <stop offset="0.2913" stopColor="#1FACA2" />
          <stop offset="0.5629" stopColor="#29C6AF" />
          <stop offset="0.8071" stopColor="#2FD6B7" />
    ...
    >
      ...
      <defs>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#FB2B30" />
          <stop offset="0.5714" stopColor="#F79281" />
          <stop offset="1" stopColor="#FBB7A0" />
        </linearGradient>
      </defs>
    </svg>
  );
    ...
    >
      ...
      <defs>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#1975FF" />
          <stop offset="0.0909" stopColor="#2C81FE" />
          <stop offset="0.7229" stopColor="#AFD0FB" />
          <stop offset="1" stopColor="#E4F0F9" />
        </linearGradient>
        <linearGradient
        ...
        >
          ...
          <stop offset="0.012" stopColor="#EEF5FF" />
          <stop offset="0.1644" stopColor="#B3D1FF" />
          <stop offset="0.3112" stopColor="#81B3FF" />
          <stop offset="0.4488" stopColor="#5B9CFF" />
          <stop offset="0.5751" stopColor="#408CFF" />
          <stop offset="0.6862" stopColor="#2F82FF" />
          <stop offset="0.7702" stopColor="#297EFF" />
        </linearGradient>
        <linearGradient
        ...
        >
          <stop stopColor="#F3F8FF" />
          <stop offset="0.013" stopColor="#EEF5FF" />
          <stop offset="0.1771" stopColor="#B3D1FF" />
          <stop offset="0.3353" stopColor="#81B3FF" />
          <stop offset="0.4836" stopColor="#5B9CFF" />
          <stop offset="0.6198" stopColor="#408CFF" />
          <stop offset="0.7395" stopColor="#2F82FF" />
          <stop offset="0.8299" stopColor="#297EFF" />
        </linearGradient>
      </defs>
    </svg>
  );
